...
??? note "지극히 개인적인 웹서버 스토리"
	...
	그 뒤 개인 블로그 웹페이지를 만들기 위해서 파이썬, 장고 관련 서적과 IT 블로그들을 몇 달간 뒤졌습니다.  
	홈페이지를 만들려면 서버와 도메인이 있어야 하고, 웹페이지를 만드는 기본골격(프레임워크)도 필요했습니다. 그렇게 한땀한땀 만든 첫 홈페이지를 완성했던 날, 생각한 무언가를 만들어냈다는 큰 성취감을 맛보았습니다. 언젠가, 여러분도 그런 성취감을 맛보실 수 있으면 좋겠습니다. 
	그런데, ESP32도 WiFi가 있어 웹서버 역할을 할 수 있습니다. AI와 함께 바이브코딩을 해보면 너무 손쉽게 원하는 웹페이지를 만들어줍니다. 흔히 말하는 '딸깍'하면 만들어주는데, 그 퀄리티가 제가 몇 달간 만들었던 것보다 더 잘 만듭니다. AI에게 진 것 같아서 부끄럽고 화가 날 것 같다가, 이거 더 발전시키면 어떻게 될까, 궁금해집니다.
## ESP32를 공유기처럼
