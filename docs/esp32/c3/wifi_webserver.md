...
<div style="display:flex; gap:8px;">
  <img src="/assets/webserver/esp32_webserver_1.png" style="width:50%;">
  <img src="/assets/webserver/esp32_webserver_2.png" style="width:50%;">
</div>
...
??? example "웹페이지 기능 설명"
	...
	*(BME280 데이터시트 스펙 기준입니다.)*
	...
	!!! info "고도는 추정값" 고도값은 직접 측정한 게 아닙니다. 기압을 해수면 표준기압(1013.25hPa)과 비교해서 계산한 추정치입니다. 현재 실제 기압이 표준과 다르면 고도 오차가 생깁니다.
