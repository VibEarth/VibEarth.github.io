...
ESP32-C3 SuperMini에는 GPIO8에 내장 상태표시용 파랑LED(전원연결은 빨강)가 달려 있습니다. 코드 몇 줄로 이 LED를 껐다 켰다 할 수 있다는 게 별것 아닌 것 같지만, 처음으로 "내가 짠 코드가 물리적인 무언가를 움직였다"는 감각은 생각보다 꽤 강렬합니다. 그 강렬함으로 여러분을 초대합니다🜨
