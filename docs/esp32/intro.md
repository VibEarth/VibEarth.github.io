...
>기상예보관 시절, 지상의 기상관측소는 많이 있었지만 정작 필요한 지점의 데이터가 없는 경우가 많았고, 상층 대기 관측 데이터의 부족으로 뇌우 등 악기상을 예상하고 실황을 파악하는데 어려움을 많이 겪었습니다.

당시의 어려움은 오래도록 마음에 남아 최근 기상관측드론을 만들기 시작했습니다.
드론에 장착할 공간은 협소하기 때문에 장착할 기상관측기는 작고, 가벼워야 합니다.
작고 가볍고 심지어 강력한 ESP32를 본 순간, 드론에 장착할 

기상관측드론에 장착할 ESP32 소형 기상관측기를 만들고자 합니다.
ESP32에 온도, 습도, 기압, 미세먼지, 가스 센서 등을 연결하여 대기질을 측정하고 모니터링하는 **소형 기상관측기**를 
